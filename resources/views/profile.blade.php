        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="card-backdrop rounded-xl p-8" style="flex: 1; min-width: 340px; display: flex; flex-direction: column;">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start" style="gap: 12px;">
                        <div class="w-1/3">
                            <p class="text-white/70 text-sm">Employee ID</p>
                        </div>
                        <div class="w-2/3">
                            <p class="text-lg font-semibold text-white">{{ $user->eid ?? 'N/A' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start" style="gap: 12px;">
                        <div class="w-1/3">
                            <p class="text-white/70 text-sm">Designation</p>
                        </div>
                        <div class="w-2/3">
                            <p class="text-lg font-semibold text-blue-400">{{ $user->designation ?? 'Not Assigned' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start" style="gap: 12px;">
                        <div class="w-1/3">
                            <p class="text-white/70 text-sm">Department</p>
                        </div>
                        <div class="w-2/3">
                            <p class="text-lg font-semibold text-purple-400">{{ $user->department ?? 'Not Assigned' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start" style="gap: 12px;">
                        <div class="w-1/3">
                            <p class="text-white/70 text-sm">Account Status</p>
                        </div>
                        <div class="w-2/3">
                            @if($user->status == 'active' || $user->status == 1)
                                <span class="inline-block px-3 py-1 bg-green-500/10 border border-green-500/20 text-green-400 rounded-lg text-sm font-semibold">
                                    Active
                                </span>
                            @else
                                <span class="inline-block px-3 py-1 bg-red-500/10 border border-red-500/20 text-red-400 rounded-lg text-sm font-semibold">
                                    Inactive
                                </span>
                            @endif
                        </div>
